...
<div class="footer">
    ...
    <a href="https://www.pitt.edu/" target="_blank">
        <img class="image"
             ...
             alt="University of Pittsburgh" width="45" height="45"
             onerror="this.style.display='none'">
    </a>
    <a href="https://github.com/osmanbeyoglulab" target="_blank">
        <img class="image"
             src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png"
             alt="GitHub" width="45" height="45">
    </a>
    <a href="https://scholar.google.com/citations?user=YzCsmdgAAAAJ&hl=en&inst=7044483460239389945" target="_blank">
        <img class="image"
             src="https://upload.wikimedia.org/wikipedia/commons/c/c7/Google_Scholar_logo.svg"
             alt="Google Scholar" width="45" height="45"
             onerror="this.style.display='none'">
    </a>
</div>
"""
